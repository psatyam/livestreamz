...
<head>
        ...
        <!-- Vendor CSS -->
        <link href="<?php echo base_url()?>admin_assets/vendors/bower_components/fullcalendar/dist/fullcalendar.min.css" rel="stylesheet">
...
<header id="header" class="clearfix" data-ma-theme="blue">
            <ul class="h-inner">
                ...
                <li class="hi-logo hidden-xs">
                    <a href="index-2.html">LiveStreamz</a>
                </li>
